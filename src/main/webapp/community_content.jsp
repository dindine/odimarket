    ...
    <div id="p_c_main">
        <div id="p_c_body">
            <ul id="info">
                ...
                <li id="name_price_sale2"
                    style="float:left; margin-top: 10px; margin-bottom: 5px;">${product.p_content }</li>
                <br>
                ...
                <li>
                    ...
                    <c:choose>
                        <c:when test="${zzimInfo.zzim_check eq '1' }">
                            <a href="javascript:login();"><img src="images/fullheart.png" id="like_img"></a><span
                                id="zzim">${product.zzim }</span>
                        </c:when>
                        <c:otherwise>
                            <a href="javascript:login();"><img src="images/emptyheart.png" id="like_img"></a><span
                                id="zzim">${product.zzim }</span>
                        </c:otherwise>
                    </c:choose>
                </li>
...
<jsp:include page="getProReply.do?p_idx=${product.p_idx }"></jsp:include>
