...
<head>
    ...
    <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fedae3690acef97ddb7d251e66dc1516"></script>

    <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fedae3690acef97ddb7d251e66dc1516&libraries=services,clusterer,drawing"></script>
            ...
            <div class="col-sm-12 text-center">
                ...
                <table class="table table-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="cust_pw" name="cust_pwd" placeholder="PASSWORD"
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="cust_pw2" name="cust_pw2"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cust_nickname" name="cust_nickname"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cust_email" id="cust_email" placeholder="E-mail"
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cust_addr" name="cust_addr" value="${cust_addr }"
                            ...
                            <td id="update_form_p" colspan="2">
                                ...
                                <div class="container" style="width: 100%">
                                    <form class="form-horizontal" role="form" method="post"
                                        ...
                                        <div class="form-group">
                                            <label for="provision" class="col-lg-10 control-label"
                                                   style="margin-bottom: 10px"><b>회원가입약관</b></label>
                                            <label for="provision" class=" control-label"
                                                   style="margin-left:350px;"> </label>
...
약관동의
                                                ...
                                                <div class="radio" style="float: left; margin-right: 20px;">
                                                    <label>
                                                        <input type="radio" id="provisionYn" name="provisionYn"
                                                               value="Y" autofocus="autofocus" checked>
                                                        동의합니다.
                                                    </label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <label for="memberInfo" class="col-lg-10 control-label"
                                                   style="margin: 30px 0px 30px 0px"><b>개인정보취급방침</b></label>
