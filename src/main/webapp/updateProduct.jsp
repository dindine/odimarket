      ...
      <%--  <input multiple="multiple" type="file" name="file" />--%>
           ...
           <%-- 
            ...
            --%>   
                  ...
                  <li>내용<span id="txt"><textarea name="p_content" rows="8" cols="50">${product.p_content }</textarea></span></li>
				...
				<div class="filebox preview-image">
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input  multiple="multiple" type="file" id="input-file" class="upload-hidden" name="uploadfile" value=${product.p_ori_image1 }>
					
				</div>
				
				 <div class="filebox preview-image">
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input  multiple="multiple" type="file" id="input-file" class="upload-hidden" name="uploadfile2" value=${product.p_ori_image2 }>
				</div>
	
             	 <div class="filebox preview-image">
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input multiple="multiple" type="file" id="input-file" class="upload-hidden" name="uploadfile3" value=${product.p_ori_image3 } >
				</div>
				 <div class="filebox preview-image">
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input multiple="multiple" type="file" id="input-file" class="upload-hidden" name="uploadfile4" value=${product.p_ori_image4 } >
				</div>
				 <div class="filebox preview-image">
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input multiple="multiple" type="file" id="input-file" class="upload-hidden" name="uploadfile5" value=${product.p_ori_image5 } >
				</div>
